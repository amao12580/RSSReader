package per.rss.core.job.simple.utils;
...
public class ScheduleJobUtils {
	 ...
	 *            the schedule job
	 */
	public static boolean createScheduleJob(Scheduler scheduler, ScheduleJobBo scheduleJobBo) {
		return createScheduleJob(scheduler, scheduleJobBo.getJobName(), scheduleJobBo.getJobGroup(),
				scheduleJobBo.getCronExpression(), scheduleJobBo.getIsSync(), scheduleJobBo);
	}
	 ...
	 *            the schedule job
	 */
	public static boolean updateScheduleJob(Scheduler scheduler, ScheduleJobBo scheduleJobBo) {
		return updateScheduleJob(scheduler, scheduleJobBo.getJobName(), scheduleJobBo.getJobGroup(),
				scheduleJobBo.getCronExpression(), scheduleJobBo.getIsSync(), scheduleJobBo);
	}
