package per.rss.core.base.quartz.local.job.quartz;
...
import per.rss.core.base.quartz.local.job.quartz.impl.JobAsyncFactory;
import per.rss.core.base.quartz.local.job.quartz.impl.JobSyncFactory;
