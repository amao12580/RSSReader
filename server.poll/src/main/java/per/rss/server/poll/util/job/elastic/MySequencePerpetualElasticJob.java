...
public class MySequencePerpetualElasticJob extends AbstractSequencePerpetualElasticJob<Object> {
	protected static transient Logger log = LoggerFactory.getLogger(MySequencePerpetualElasticJob.class);
