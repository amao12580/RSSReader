...
public class JsoupXMLHandler extends XMLHandler {
	...
	protected Feed doParseXML(String feedId, Date lastedSyncDate, String xml) {
		...
		if (CollectionUtils.isEmpty(description)) {
			...
			feed.setDescription(descriptionFirst);
		}
		...
		if (CollectionUtils.isEmpty(language)) {
			...
			feed.setLanguage(languageFirst);
		}
		...
		if (CollectionUtils.isEmpty(generator)) {
			...
			feed.setGenerator(generatorFirst);
		}
		...
		if (CollectionUtils.isEmpty(lastBuildDate)) {
			...
			feed.setLastBuildDate(lastBuildDateFirst);
		}
		...
		if (CollectionUtils.isEmpty(copyright)) {
			...
			feed.setCopyright(copyrightFirst);
		}
		...
		if (CollectionUtils.isEmpty(category)) {
			...
			feed.setCategory(categoryFirst);
		}
		...
		if (CollectionUtils.isEmpty(ttl)) {
			...
			feed.setTtl(Long.valueOf(ttlFirst));
		}
