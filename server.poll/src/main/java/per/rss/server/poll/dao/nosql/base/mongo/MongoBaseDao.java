package per.rss.server.poll.dao.nosql.base.mongo;
...
public interface MongoBaseDao<T> {
	 ...
	 */  
	public Pagination<T> getDistinctPage(String collection,String distinct_key,int currentPage,int pageSize,Query query);
